...
public class JXRefreshLayout extends LinearLayout {
    ...
    public JXRefreshLayout(Context context) {
        super(context);
        init(context);
    }

    public JXRefreshLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
